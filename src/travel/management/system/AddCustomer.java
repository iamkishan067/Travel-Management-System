...
public class AddCustomer extends JFrame implements ActionListener{
    ...
    AddCustomer(String username){
        ...
        JLabel l11 = new JLabel("Add Customer");
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            ResultSet rs = con.s.executeQuery(sql);
            if(rs.next()){
                JOptionPane.showMessageDialog(null, "Details can be added only once! Please try Update Customer details");
        ...
        if(ae.getSource() == b1){
            ...
            String sql = "insert into customer values ('" + username + "' , '"+ id_type + "' , '" + number + "' , '"+ name + "' , '"+ gender + "' , '"+ country + "' , '"+ address + "' , '"+ phone+ "' , '"+ email + "')";
